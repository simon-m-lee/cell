...
class TestPasses implements TestCell<Never> {
  ...
  @override
  FutureOr<bool> action(Function action, {required Cell host, Arguments? arguments}) => true;
  ...
  @override
  FutureOr<bool> _checkActionRules(Function action, Never host, Arguments? arguments) {
    return true;
  }

  @override
  FutureOr<bool> _checkArguments(List<dynamic> elements, int index, Never host, Function action) {
    return true;
  }

  @override
  TestCell<Never>? get _parent => null;

}

class _TestCellReadOnly implements TestCell<Never> {

  const _TestCellReadOnly();
