...
mixin Deputy<C extends Cell> on Cell {
  ...
  bool operator ==(Object other) {
    ...
    if (other is Deputy) {
      // Two deputies are equal if they represent the same underlying cell
      return identical(_nucleus.bind, other._nucleus.bind);
    }
    if (other is Cell) {
      // A deputy is equal to a cell if it is a proxy for that specific cell
      return identical(other._nucleus.bind, other);
    }
    return false;
  }
  ...
  ///
  /// ### How it works
  /// Delegates to the bound cell's hash code, so a deputy and its principal
  /// have the same hash.
  @override
  int get hashCode => _nucleus.bind.hashCode;
