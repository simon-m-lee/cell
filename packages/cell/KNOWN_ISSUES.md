...
**RC** (Mitosis `1.0.0-rc.4`, Release Candidate, not published). Prefer
...
| `ARCHITECTURE.md` intro / §7 | may lag README | Valve exists; package is RC `1.0.0-rc.4`     |
...
- `pubspec.yaml` `version:` `1.0.0-rc.4`
