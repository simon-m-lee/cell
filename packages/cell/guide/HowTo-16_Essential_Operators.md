...
| 3 | `observe` | Observation | Side effects |
| 4 | `derive` | Transformation | Projections |
| 5 | `debounce` | Flow Control | Stability-based |
| 6 | `distinct` | Flow Control | Deduplication |
| 7 | `throttle` | Flow Control | Rate limiting |
| 8 | `asyncMap` | Transformation | Background tasks |
| 9 | `fromFuture` | Bridge | One-time async |
| 10 | `fromStream` | Bridge | Continuous async |
| 11 | `synthesis` | Transformation | Multi-source aggregation |
| 12 | `hub` | Routing | Signal routing |
| 13 | `switchMap` | Transformation | Dynamic source selection |
| 14 | `sanitized` | Transformation | Data redaction |
